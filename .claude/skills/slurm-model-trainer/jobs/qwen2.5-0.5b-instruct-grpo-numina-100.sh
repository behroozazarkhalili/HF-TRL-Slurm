#!/bin/bash
# =============================================================================
# Qwen2.5-0.5B-Instruct GRPO Training on NuMina-CoT
# Auto-generated by SLURM Job Generator
# =============================================================================

#SBATCH --job-name=qwen2.5-0.5b-instruct-grpo-numina-cot
...
DATASET_NAME="AI-MO/NuMina-CoT"

# Sample size configuration (for model naming when using streaming)
MAX_SAMPLES=100
SAMPLE_SIZE_LABEL="100"

HUB_MODEL_ID="ermiaazarkhalili/Qwen2.5-0.5B-Instruct-GRPO-NuMina-CoT-100"
GGUF_REPO_ID="ermiaazarkhalili/Qwen2.5-0.5B-Instruct-GRPO-NuMina-CoT-100-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen2.5-0.5b-instruct-grpo-numina-cot-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "qwen2.5-0.5b-instruct-grpo-numina" \
    --run_name "qwen2.5-0.5b-instruct-grpo-numina-cot-$SLURM_JOB_ID" \
    --streaming \
    --max_samples 100 \
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Qwen2.5-0.5B-Instruct-GRPO-NuMina-CoT-100" \
