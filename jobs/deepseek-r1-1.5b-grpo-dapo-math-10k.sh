...
HUB_MODEL_ID='ermiaazarkhalili/DeepSeek-R1-Distill-Qwen-1.5B-GRPO-DAPO-Math-17k-Processed-10K'
GGUF_REPO_ID='ermiaazarkhalili/DeepSeek-R1-Distill-Qwen-1.5B-GRPO-DAPO-Math-17k-Processed-10K-GGUF'
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "DeepSeek-R1-Distill-Qwen-1.5B-GRPO-DAPO-Math-17k-Processed-10K" \
