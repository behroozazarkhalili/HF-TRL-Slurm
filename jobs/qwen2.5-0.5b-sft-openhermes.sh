...
#SBATCH --job-name=qwen2.5-0.5b-sft-openhermes
...
HUB_MODEL_ID="ermiaazarkhalili/Qwen2.5-0.5B-SFT-OpenHermes"
GGUF_REPO_ID="ermiaazarkhalili/Qwen2.5-0.5B-SFT-OpenHermes-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen2.5-0.5b-sft-openhermes-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_sft.py \
    ...
    --run_name "qwen2.5-0.5b-sft-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Qwen2.5-0.5B-SFT-OpenHermes" \
