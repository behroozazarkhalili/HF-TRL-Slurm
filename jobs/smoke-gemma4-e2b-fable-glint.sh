#!/bin/bash
#SBATCH --job-name=smoke-gemma4-e2b-fable-glint
...
OUTPUT_DIR="/scratch/$USER/outputs/fable-smoke-gemma4_e2b-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "SMOKE: Gemma4-E2B on FABLE-5 (Fable5-Glint)"
...
export NB_INPUT="$NB_DIR/fable_distillation_gemma4-e2b_fable-glint_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_gemma4_e2b_b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_gemma4_e2b_b_smoke_output.ipynb"
