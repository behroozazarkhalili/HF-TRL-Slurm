...
# Real training: Qwen3-8B on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: Qwen3-8B on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_qwen3-8b_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_qwen3_8b_d_train_output.ipynb"
