#!/bin/bash
#SBATCH --job-name=train-vibethinker-3b-sft
...
# =============================================================================
# Real (non-smoke) training: VibeThinker-3B SFT distillation
...
echo "=========================================="
echo "TRAIN: VibeThinker-3B SFT distillation (full epoch)"
echo "=========================================="
...
NB_INPUT="$NB_DIR/sft_distillation_vibethinker-3b_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/sft_vibethinker_3b_train_output.ipynb"
