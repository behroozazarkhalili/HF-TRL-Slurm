...
HUB_MODEL_ID="ermiaazarkhalili/Qwen2.5-0.5B-Instruct-GRPO-NuminaMath"
GGUF_REPO_ID="ermiaazarkhalili/Qwen2.5-0.5B-Instruct-GRPO-NuminaMath-GGUF"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Qwen2.5-0.5B-Instruct-GRPO-NuminaMath" \
