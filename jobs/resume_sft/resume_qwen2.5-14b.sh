#!/bin/bash
# =============================================================================
# Resume Qwen2.5-14B SFT Training from Checkpoint
# Reduced LoRA rank (32) and grad_accum (8) to prevent OOM
# =============================================================================

#SBATCH --job-name=qwen2.5-14b-sft-resume
...
#SBATCH --output=/home/ermia/projects/def-maxwl/ermia/HF-TRL/jobs/logs/qwen2.5-14b-sft-resume-%j.out
#SBATCH --error=/home/ermia/projects/def-maxwl/ermia/HF-TRL/jobs/logs/qwen2.5-14b-sft-resume-%j.err
...
CHECKPOINT_DIR="/scratch/ermia/outputs/qwen2.5-14b-sft-16615023/checkpoint-4800"
OUTPUT_DIR="/scratch/ermia/outputs/qwen2.5-14b-sft-resume-$SLURM_JOB_ID"
...
python $SKILL_DIR/scripts/train_sft.py \
    ...
    --run_name "qwen2.5-14b-sft-resume-$SLURM_JOB_ID"
