#!/bin/bash
# =============================================================================
# Resume Qwen3-8B SFT Training from Checkpoint
# Reduced LoRA rank (32) and grad_accum (8) to prevent OOM
# =============================================================================

#SBATCH --job-name=qwen3-8b-sft-resume
...
#SBATCH --output=/home/ermia/projects/def-maxwl/ermia/HF-TRL/jobs/logs/qwen3-8b-sft-resume-%j.out
#SBATCH --error=/home/ermia/projects/def-maxwl/ermia/HF-TRL/jobs/logs/qwen3-8b-sft-resume-%j.err
...
CHECKPOINT_DIR="/scratch/ermia/outputs/qwen3-8b-sft-16615026/checkpoint-7200"
OUTPUT_DIR="/scratch/ermia/outputs/qwen3-8b-sft-resume-$SLURM_JOB_ID"
...
python $SKILL_DIR/scripts/train_sft.py \
    ...
    --run_name "qwen3-8b-sft-resume-$SLURM_JOB_ID"
