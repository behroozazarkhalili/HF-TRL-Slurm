...
HUB_MODEL_ID="ermiaazarkhalili/Nemotron-Flash-3B-Instruct-GRPO-NuminaMath"
GGUF_REPO_ID="ermiaazarkhalili/Nemotron-Flash-3B-Instruct-GRPO-NuminaMath-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/nemotron-3b-grpo-numina-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --report_to trackio \
    --project "grpo-numina" \
    --run_name "nemotron-3b-grpo-numina-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Nemotron-Flash-3B-Instruct-GRPO-NuminaMath" \
