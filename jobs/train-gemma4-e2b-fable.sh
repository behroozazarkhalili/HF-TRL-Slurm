#!/bin/bash
#SBATCH --job-name=train-gemma4-e2b-fable
...
# Real training: Gemma4-E2B on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: Gemma4-E2B on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_gemma4-e2b_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_gemma4_e2b_d_train_output.ipynb"
