#!/bin/bash
#SBATCH --job-name=smoke-fastcontext-4b-rl-xlam
...
echo "=========================================="
echo "SMOKE: FastContext-4B-RL_base xLAM function calling (compat validation)"
echo "=========================================="
...
export NB_INPUT="$NB_DIR/xlam_function_calling_fastcontext-4b-rl_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/xlam_fastcontext_4b_rl_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/xlam_fastcontext_4b_rl_smoke_output.ipynb"
