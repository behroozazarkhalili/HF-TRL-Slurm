...
HUB_MODEL_ID='ermiaazarkhalili/LFM2.5-1.2B-Instruct-GRPO-NuminaMath-smoke-100'
GGUF_REPO_ID='ermiaazarkhalili/LFM2.5-1.2B-Instruct-GRPO-NuminaMath-smoke-100-GGUF'
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "LFM2.5-1.2B-Instruct-GRPO-NuminaMath-smoke-100" \
