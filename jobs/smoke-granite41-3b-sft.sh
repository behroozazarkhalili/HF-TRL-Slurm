#!/bin/bash
#SBATCH --job-name=smoke-granite41-3b-sft
...
echo "=========================================="
echo "SMOKE: Granite 4.1-3B SFT distillation (compat validation)"
echo "=========================================="
...
export NB_INPUT="$NB_DIR/sft_distillation_granite4.1-3b_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/sft_granite41_3b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/sft_granite41_3b_smoke_output.ipynb"
