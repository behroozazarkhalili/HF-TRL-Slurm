#!/bin/bash
#SBATCH --job-name=smoke-granite41-3b-xlam
...
echo "=========================================="
echo "SMOKE: Granite 4.1-3B xLAM function calling (compat validation)"
echo "=========================================="
...
export NB_INPUT="$NB_DIR/xlam_function_calling_granite4.1-3b_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/xlam_granite41_3b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/xlam_granite41_3b_smoke_output.ipynb"
