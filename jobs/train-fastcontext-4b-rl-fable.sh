#!/bin/bash
#SBATCH --job-name=train-fastcontext-4b-rl-fable
...
# Real training: FastContext-4B-RL on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: FastContext-4B-RL on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_fastcontext-4b-rl_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_fastcontext_4b_rl_d_train_output.ipynb"
