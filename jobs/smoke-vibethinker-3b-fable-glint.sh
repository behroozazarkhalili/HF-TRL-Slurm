#!/bin/bash
#SBATCH --job-name=smoke-vibethinker-3b-fable-glint
...
OUTPUT_DIR="/scratch/$USER/outputs/fable-smoke-vibethinker_3b-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "SMOKE: VibeThinker-3B on FABLE-5 (Fable5-Glint)"
...
export NB_INPUT="$NB_DIR/fable_distillation_vibethinker-3b_fable-glint_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_vibethinker_3b_b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_vibethinker_3b_b_smoke_output.ipynb"
