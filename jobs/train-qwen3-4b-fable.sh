#!/bin/bash
#SBATCH --job-name=train-qwen3-4b-fable
...
# Real training: Qwen3-4B on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: Qwen3-4B on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_qwen3-4b_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_qwen3_4b_d_train_output.ipynb"
