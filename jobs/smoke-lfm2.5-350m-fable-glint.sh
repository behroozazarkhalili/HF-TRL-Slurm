#!/bin/bash
#SBATCH --job-name=smoke-lfm2.5-350m-fable-glint
...
OUTPUT_DIR="/scratch/$USER/outputs/fable-smoke-lfm25_350m-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "SMOKE: LFM2.5-350M on FABLE-5 (Fable5-Glint)"
...
export NB_INPUT="$NB_DIR/fable_distillation_lfm2.5-350m_fable-glint_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_lfm25_350m_b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_lfm25_350m_b_smoke_output.ipynb"
