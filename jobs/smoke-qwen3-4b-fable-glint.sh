#!/bin/bash
#SBATCH --job-name=smoke-qwen3-4b-fable-glint
...
OUTPUT_DIR="/scratch/$USER/outputs/fable-smoke-qwen3_4b-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "SMOKE: Qwen3-4B on FABLE-5 (Fable5-Glint)"
...
export NB_INPUT="$NB_DIR/fable_distillation_qwen3-4b_fable-glint_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_qwen3_4b_b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_qwen3_4b_b_smoke_output.ipynb"
