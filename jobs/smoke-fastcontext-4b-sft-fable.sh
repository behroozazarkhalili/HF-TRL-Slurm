#!/bin/bash
#SBATCH --job-name=smoke-fastcontext-4b-sft-fable
...
echo "=========================================="
echo "SMOKE: FastContext-4B-SFT on FABLE-5 (Fable5)"
...
export NB_INPUT="$NB_DIR/fable_distillation_fastcontext-4b-sft_fable_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_fastcontext_4b_sft_d_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_fastcontext_4b_sft_d_smoke_output.ipynb"
