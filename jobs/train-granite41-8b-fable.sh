#!/bin/bash
#SBATCH --job-name=train-granite41-8b-fable
...
# Real training: Granite-4.1-8B on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: Granite-4.1-8B on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_granite41-8b_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_granite41_8b_d_train_output.ipynb"
