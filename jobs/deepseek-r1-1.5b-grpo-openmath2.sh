#!/bin/bash
# =============================================================================
# DeepSeek-R1-Distill-Qwen-1.5B GRPO Training on nvidia/OpenMathInstruct-2
# Full Pipeline: Train → Model Card → GGUF Conversion → HF Upload
# Dataset: nvidia/OpenMathInstruct-2 (500K samples, streaming mode)
# =============================================================================

#SBATCH --job-name=deepseek-r1-1.5b-grpo-openmath2
...
HUB_MODEL_ID="ermiaazarkhalili/DeepSeek-R1-Distill-Qwen-1.5B-GRPO-OpenMath2"
GGUF_REPO_ID="ermiaazarkhalili/DeepSeek-R1-Distill-Qwen-1.5B-GRPO-OpenMath2-GGUF"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --run_name "deepseek-r1-1.5b-grpo-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "DeepSeek-R1-Distill-Qwen-1.5B-GRPO-OpenMath2" \
