...
# Sample size configuration (reduced from 100K to fit within 7-day limit)
MAX_SAMPLES=50000
SAMPLE_SIZE_LABEL="50K"  # Human-readable format for model naming

# Model naming with sample size
HUB_MODEL_ID="ermiaazarkhalili/SmolLM2-1.7B-Instruct-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}"
GGUF_REPO_ID="ermiaazarkhalili/SmolLM2-1.7B-Instruct-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/smollm2-1.7b-grpo-numina-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --run_name "smollm2-1.7b-grpo-numina-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "SmolLM2-1.7B-Instruct-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}" \
