#!/bin/bash
# =============================================================================
# Phi-4-mini-instruct GRPO Training on NuminaMath-CoT
# Auto-generated by SLURM Job Generator
# =============================================================================

#SBATCH --job-name=phi-4-mini-instruct-grpo-numinamath-cot
...
HUB_MODEL_ID='ermiaazarkhalili/Phi-4-mini-instruct-GRPO-NuminaMath-10K'
GGUF_REPO_ID='ermiaazarkhalili/Phi-4-mini-instruct-GRPO-NuminaMath-10K-GGUF'
...
export OUTPUT_DIR="$SCRATCH/outputs/phi-4-mini-instruct-grpo-numinamath-cot-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "phi-4-mini-instruct-grpo-numinamath" \
    --run_name "phi-4-mini-instruct-grpo-numinamath-cot-$SLURM_JOB_ID" \
    --streaming \
    --max_samples 10000 \
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Phi-4-mini-instruct-GRPO-NuminaMath-10K" \
