#!/bin/bash
# =============================================================================
# SMOKE TEST: LFM2.5-1.2B SFT Distillation on Claude Reasoning
# 100 samples, <1h, validates: preprocessing adapter, SFT training, inference
# =============================================================================

#SBATCH --job-name=lfm2.5-1.2b-sft-claude
...
HUB_MODEL_ID='ermiaazarkhalili/LFM2.5-1.2B-SFT-Claude-Reasoning-smoke-100'
...
# =============================================================================
echo "=========================================="
echo "SMOKE: LFM2.5-1.2B SFT Claude Reasoning"
...
export OUTPUT_DIR="$SCRATCH/outputs/lfm2.5-1.2b-sft-claude-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_sft_new.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "lfm2.5-1.2b-sft-claude-reasoning" \
    --run_name "lfm2.5-1.2b-sft-claude-smoke-$SLURM_JOB_ID"
