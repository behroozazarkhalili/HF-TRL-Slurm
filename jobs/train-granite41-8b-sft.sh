#!/bin/bash
#SBATCH --job-name=train-granite41-8b-sft
...
# =============================================================================
# Real (non-smoke) training: Granite 4.1-8B SFT distillation
...
echo "=========================================="
echo "TRAIN: Granite 4.1-8B SFT distillation (full epoch)"
echo "=========================================="
...
NB_INPUT="$NB_DIR/sft_distillation_granite4.1-8b_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/sft_granite41_8b_train_output.ipynb"
