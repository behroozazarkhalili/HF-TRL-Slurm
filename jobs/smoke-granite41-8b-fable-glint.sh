#!/bin/bash
#SBATCH --job-name=smoke-granite41-8b-fable-glint
...
OUTPUT_DIR="/scratch/$USER/outputs/fable-smoke-granite41_8b-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "SMOKE: Granite-4.1-8B on FABLE-5 (Fable5-Glint)"
...
export NB_INPUT="$NB_DIR/fable_distillation_granite41-8b_fable-glint_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_granite41_8b_b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_granite41_8b_b_smoke_output.ipynb"
