#!/bin/bash
#SBATCH --job-name=smoke-vibethinker-3b-sft
...
echo "=========================================="
echo "SMOKE: VibeThinker-3B SFT distillation (compat validation)"
echo "=========================================="
...
export NB_INPUT="$NB_DIR/sft_distillation_vibethinker-3b_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/sft_vibethinker_3b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/sft_vibethinker_3b_smoke_output.ipynb"
