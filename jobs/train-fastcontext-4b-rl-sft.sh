#!/bin/bash
#SBATCH --job-name=train-fastcontext-4b-rl-sft
...
# =============================================================================
# Real (non-smoke) training: FastContext-4B-RL_base SFT distillation
...
echo "=========================================="
echo "TRAIN: FastContext-4B-RL_base SFT distillation (full epoch)"
echo "=========================================="
...
NB_INPUT="$NB_DIR/sft_distillation_fastcontext-4b-rl_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/sft_fastcontext_4b_rl_train_output.ipynb"
