#!/bin/bash
#SBATCH --job-name=smoke-qwen35-9b-fable
...
echo "=========================================="
echo "SMOKE: Qwen3.5-9B on FABLE-5 (Fable5)"
...
export NB_INPUT="$NB_DIR/fable_distillation_qwen35-9b_fable_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_qwen35_9b_d_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_qwen35_9b_d_smoke_output.ipynb"
