#!/bin/bash
#SBATCH --job-name=smoke-carnice-9b-fable
...
echo "=========================================="
echo "SMOKE: Carnice-9B on FABLE-5 (Fable5)"
...
export NB_INPUT="$NB_DIR/fable_distillation_carnice-9b_fable_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_carnice_9b_d_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_carnice_9b_d_smoke_output.ipynb"
