#!/bin/bash
#SBATCH --job-name=smoke-gemma4-e4b-fable
...
echo "=========================================="
echo "SMOKE: Gemma4-E4B on FABLE-5 (Fable5)"
...
export NB_INPUT="$NB_DIR/fable_distillation_gemma4-e4b_fable_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_gemma4_e4b_d_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_gemma4_e4b_d_smoke_output.ipynb"
