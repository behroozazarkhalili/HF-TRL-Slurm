...
MAX_SAMPLES=5000
SAMPLE_SIZE_LABEL="5K"

HUB_MODEL_ID='ermiaazarkhalili/SmolLM3-3B-GRPO-NuminaMath-5K'
GGUF_REPO_ID='ermiaazarkhalili/SmolLM3-3B-GRPO-NuminaMath-5K-GGUF'
...
PYTHONUNBUFFERED=1 python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "SmolLM3-3B-GRPO-NuminaMath-5K" \
