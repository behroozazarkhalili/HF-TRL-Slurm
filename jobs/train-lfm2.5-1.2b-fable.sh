#!/bin/bash
#SBATCH --job-name=train-lfm2.5-1.2b-fable
...
# Real training: LFM2.5-1.2B on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: LFM2.5-1.2B on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_lfm2.5-1.2b_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_lfm25_12b_d_train_output.ipynb"
