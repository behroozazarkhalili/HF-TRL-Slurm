#!/bin/bash
# =============================================================================
# SMOKE TEST: Qwen3.5-0.8B SFT Distillation on Claude Reasoning
# 100 samples, <1h, validates: preprocessing adapter, SFT training, inference
# =============================================================================

#SBATCH --job-name=qwen3.5-0.8b-sft-claude
...
HUB_MODEL_ID='ermiaazarkhalili/Qwen3.5-0.8B-SFT-Claude-Reasoning-smoke-100'
...
# =============================================================================
echo "=========================================="
echo "SMOKE: Qwen3.5-0.8B SFT Claude Reasoning"
...
export OUTPUT_DIR="$SCRATCH/outputs/qwen3.5-0.8b-sft-claude-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_sft_new.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "qwen3.5-0.8b-sft-claude-reasoning" \
    --run_name "qwen3.5-0.8b-sft-claude-smoke-$SLURM_JOB_ID"
