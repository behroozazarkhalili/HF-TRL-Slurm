#!/bin/bash
#SBATCH --job-name=smoke-granite41-8b-fable
...
echo "=========================================="
echo "SMOKE: Granite-4.1-8B on FABLE-5 (Fable5)"
...
export NB_INPUT="$NB_DIR/fable_distillation_granite41-8b_fable_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_granite41_8b_d_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_granite41_8b_d_smoke_output.ipynb"
