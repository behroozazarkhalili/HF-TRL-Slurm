...
HUB_MODEL_ID="ermiaazarkhalili/SmolLM2-135M-Instruct-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}"
GGUF_REPO_ID="ermiaazarkhalili/SmolLM2-135M-Instruct-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/smollm2-135m-grpo-numina-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "SmolLM2-135M-Instruct-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}" \
