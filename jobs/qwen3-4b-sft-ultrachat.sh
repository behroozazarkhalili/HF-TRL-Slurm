#!/bin/bash
# =============================================================================
# Qwen3-4B SFT Training on UltraChat-200k
# Full Pipeline: Train → Eval (MMLU, GSM8K) → GGUF Conversion → HF Upload
# =============================================================================

#SBATCH --job-name=qwen3-4b-sft-ultrachat
...
GGUF_REPO_ID="ermiaazarkhalili/Qwen3-4B-SFT-UltraChat-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen3-4b-sft-$SLURM_JOB_ID
