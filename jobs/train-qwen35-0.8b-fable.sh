#!/bin/bash
#SBATCH --job-name=train-qwen35-0.8b-fable
...
# Real training: Qwen3.5-0.8B on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: Qwen3.5-0.8B on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_qwen35-0.8b_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_qwen35_08b_d_train_output.ipynb"
