#!/bin/bash
#SBATCH --job-name=smoke-lfm2.5-350m-fable
...
echo "=========================================="
echo "SMOKE: LFM2.5-350M on FABLE-5 (Fable5)"
...
export NB_INPUT="$NB_DIR/fable_distillation_lfm2.5-350m_fable_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_lfm25_350m_d_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_lfm25_350m_d_smoke_output.ipynb"
