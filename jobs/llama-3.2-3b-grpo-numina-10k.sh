#!/bin/bash
# =============================================================================
# Llama-3.2-3B-Instruct GRPO Training on NuminaMath-CoT
# Auto-generated by SLURM Job Generator
# =============================================================================

#SBATCH --job-name=llama-3.2-3b-instruct-grpo-numinamath-cot
...
HUB_MODEL_ID='ermiaazarkhalili/Llama-3.2-3B-Instruct-GRPO-NuminaMath-10K'
GGUF_REPO_ID='ermiaazarkhalili/Llama-3.2-3B-Instruct-GRPO-NuminaMath-10K-GGUF'
...
export OUTPUT_DIR="$SCRATCH/outputs/llama-3.2-3b-instruct-grpo-numinamath-cot-$SLURM_JOB_ID"
...
PYTHONUNBUFFERED=1 python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "llama-3.2-3b-instruct-grpo-numinamath" \
    --run_name "llama-3.2-3b-instruct-grpo-numinamath-cot-$SLURM_JOB_ID" \
    --streaming \
    --max_samples 10000 \
...
PYTHONUNBUFFERED=1 python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Llama-3.2-3B-Instruct-GRPO-NuminaMath-10K" \
