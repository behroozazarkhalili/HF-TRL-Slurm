#!/bin/bash
#SBATCH --job-name=train-fastcontext-4b-rl-xlam
...
# =============================================================================
# Real (non-smoke) training: FastContext-4B-RL_base xLAM function calling
...
echo "=========================================="
echo "TRAIN: FastContext-4B-RL_base xLAM function calling (full epoch)"
echo "=========================================="
...
NB_INPUT="$NB_DIR/xlam_function_calling_fastcontext-4b-rl_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/xlam_fastcontext_4b_rl_train_output.ipynb"
