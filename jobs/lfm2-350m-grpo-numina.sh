...
HUB_MODEL_ID="ermiaazarkhalili/LFM2-350M-GRPO-NuminaMath"
GGUF_REPO_ID="ermiaazarkhalili/LFM2-350M-GRPO-NuminaMath-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/lfm2-350m-grpo-numina-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --project "grpo-numina" \
    --run_name "lfm2-350m-grpo-numina-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "LFM2-350M-GRPO-NuminaMath" \
