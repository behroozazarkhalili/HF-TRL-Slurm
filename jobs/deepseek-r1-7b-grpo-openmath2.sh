...
HUB_MODEL_ID="ermiaazarkhalili/DeepSeek-R1-Distill-Qwen-7B-GRPO-OpenMath2"
GGUF_REPO_ID="ermiaazarkhalili/DeepSeek-R1-Distill-Qwen-7B-GRPO-OpenMath2-GGUF"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --run_name "deepseek-r1-7b-grpo-$SLURM_JOB_ID" \
    --use_4bit
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "DeepSeek-R1-Distill-Qwen-7B-GRPO-OpenMath2" \
