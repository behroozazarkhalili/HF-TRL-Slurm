#!/bin/bash
#SBATCH --job-name=train-granite41-3b-xlam
...
# =============================================================================
# Real (non-smoke) training: Granite 4.1-3B xLAM function calling
...
echo "=========================================="
echo "TRAIN: Granite 4.1-3B xLAM function calling (full epoch)"
echo "=========================================="
...
NB_INPUT="$NB_DIR/xlam_function_calling_granite4.1-3b_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/xlam_granite41_3b_train_output.ipynb"
