#!/bin/bash
#SBATCH --job-name=smoke-qwen35-0.8b-fable
...
echo "=========================================="
echo "SMOKE: Qwen3.5-0.8B on FABLE-5 (Fable5)"
...
export NB_INPUT="$NB_DIR/fable_distillation_qwen35-0.8b_fable_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_qwen35_08b_d_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_qwen35_08b_d_smoke_output.ipynb"
