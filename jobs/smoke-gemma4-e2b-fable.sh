#!/bin/bash
#SBATCH --job-name=smoke-gemma4-e2b-fable
...
echo "=========================================="
echo "SMOKE: Gemma4-E2B on FABLE-5 (Fable5)"
...
export NB_INPUT="$NB_DIR/fable_distillation_gemma4-e2b_fable_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_gemma4_e2b_d_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_gemma4_e2b_d_smoke_output.ipynb"
