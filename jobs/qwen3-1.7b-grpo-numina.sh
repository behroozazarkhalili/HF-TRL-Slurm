...
HUB_MODEL_ID="ermiaazarkhalili/Qwen3-1.7B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}"
GGUF_REPO_ID="ermiaazarkhalili/Qwen3-1.7B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen3-1.7b-grpo-numina-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --report_to trackio \
    --project "grpo-numina" \
    --run_name "qwen3-1.7b-grpo-numina-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Qwen3-1.7B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}" \
