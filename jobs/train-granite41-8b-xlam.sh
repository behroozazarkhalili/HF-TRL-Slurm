#!/bin/bash
#SBATCH --job-name=train-granite41-8b-xlam
...
# =============================================================================
# Real (non-smoke) training: Granite 4.1-8B xLAM function calling
...
echo "=========================================="
echo "TRAIN: Granite 4.1-8B xLAM function calling (full epoch)"
echo "=========================================="
...
NB_INPUT="$NB_DIR/xlam_function_calling_granite4.1-8b_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/xlam_granite41_8b_train_output.ipynb"
