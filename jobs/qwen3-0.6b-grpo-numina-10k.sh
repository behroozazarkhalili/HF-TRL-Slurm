...
HUB_MODEL_ID='ermiaazarkhalili/Qwen3-0.6B-GRPO-NuminaMath-10K'
GGUF_REPO_ID='ermiaazarkhalili/Qwen3-0.6B-GRPO-NuminaMath-10K-GGUF'
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Qwen3-0.6B-GRPO-NuminaMath-10K" \
