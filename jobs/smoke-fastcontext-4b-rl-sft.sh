#!/bin/bash
#SBATCH --job-name=smoke-fastcontext-4b-rl-sft
...
echo "=========================================="
echo "SMOKE: FastContext-4B-RL_base SFT distillation (compat validation)"
echo "=========================================="
...
export NB_INPUT="$NB_DIR/sft_distillation_fastcontext-4b-rl_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/sft_fastcontext_4b_rl_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/sft_fastcontext_4b_rl_smoke_output.ipynb"
