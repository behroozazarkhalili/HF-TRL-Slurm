#!/bin/bash
#SBATCH --job-name=train-qwen35-9b-fable
...
# Real training: Qwen3.5-9B on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: Qwen3.5-9B on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_qwen35-9b_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_qwen35_9b_d_train_output.ipynb"
