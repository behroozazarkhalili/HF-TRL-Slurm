#!/bin/bash
# =============================================================================
# SMOKE TEST: Qwen3.5-0.8B GRPO on Claude Reasoning Distillation
# 100 samples, <1h, validates: GRPO training with claude-reasoning-distillation grpo config
# =============================================================================

#SBATCH --job-name=qwen3.5-0.8b-grpo-claude
...
HUB_MODEL_ID='ermiaazarkhalili/Qwen3.5-0.8B-GRPO-Claude-Reasoning-smoke-100'
...
# =============================================================================
echo "=========================================="
echo "SMOKE: Qwen3.5-0.8B GRPO Claude Reasoning"
...
export OUTPUT_DIR="$SCRATCH/outputs/qwen3.5-0.8b-grpo-claude-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "qwen3.5-0.8b-grpo-claude-reasoning" \
    --run_name "qwen3.5-0.8b-grpo-claude-smoke-$SLURM_JOB_ID" \
    --streaming \
