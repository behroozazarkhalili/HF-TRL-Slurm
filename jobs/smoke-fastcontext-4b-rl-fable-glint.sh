#!/bin/bash
#SBATCH --job-name=smoke-fastcontext-4b-rl-fable-glint
...
OUTPUT_DIR="/scratch/$USER/outputs/fable-smoke-fastcontext_4b_rl-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "SMOKE: FastContext-4B-RL on FABLE-5 (Fable5-Glint)"
...
export NB_INPUT="$NB_DIR/fable_distillation_fastcontext-4b-rl_fable-glint_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_fastcontext_4b_rl_b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_fastcontext_4b_rl_b_smoke_output.ipynb"
