...
HUB_MODEL_ID="ermiaazarkhalili/Qwen3-8B-GRPO-OpenMath2"
GGUF_REPO_ID="ermiaazarkhalili/Qwen3-8B-GRPO-OpenMath2-GGUF"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --run_name "qwen3-8b-grpo-$SLURM_JOB_ID" \
    --use_4bit
