#!/bin/bash
#SBATCH --job-name=smoke-qwen35-4b-sft
...
echo "=========================================="
echo "SMOKE: Qwen3.5-4B SFT distillation (Jackrong recipe validation)"
echo "=========================================="
...
export NB_INPUT="$NB_DIR/sft_distillation_qwen3.5-4b_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/sft_qwen35_4b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/sft_qwen35_4b_smoke_output.ipynb"
