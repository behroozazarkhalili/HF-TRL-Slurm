...
HUB_MODEL_ID="ermiaazarkhalili/LFM2-1.2B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}"
GGUF_REPO_ID="ermiaazarkhalili/LFM2-1.2B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/lfm2-1.2b-grpo-numina-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --report_to trackio \
    --project "grpo-numina" \
    --run_name "lfm2-1.2b-grpo-numina-$SLURM_JOB_ID"
