#!/bin/bash
#SBATCH --job-name=smoke-qwen3-4b-fable
...
echo "=========================================="
echo "SMOKE: Qwen3-4B on FABLE-5 (Fable5)"
...
export NB_INPUT="$NB_DIR/fable_distillation_qwen3-4b_fable_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_qwen3_4b_d_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_qwen3_4b_d_smoke_output.ipynb"
