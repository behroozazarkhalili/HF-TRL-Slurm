#!/bin/bash
#SBATCH --job-name=smoke-vibethinker-3b-xlam
...
OUTPUT_DIR="/scratch/$USER/outputs/unsloth-smoke-vibethinker-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"

mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "SMOKE: VibeThinker-3B xLAM function calling (compat validation)"
echo "=========================================="
...
export NB_INPUT="$NB_DIR/xlam_function_calling_vibethinker-3b_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/xlam_vibethinker_3b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/xlam_vibethinker_3b_smoke_output.ipynb"
