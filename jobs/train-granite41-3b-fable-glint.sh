#!/bin/bash
#SBATCH --job-name=train-granite41-3b-fable-glint
...
# Real training: Granite-4.1-3B on FABLE-5 (Fable5-Glint, 4,350 rows, 3 epochs).
...
OUTPUT_DIR="/scratch/$USER/outputs/fable-train-granite41_3b-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "TRAIN: Granite-4.1-3B on FABLE-5 (Fable5-Glint)"
...
NB_INPUT="$NB_DIR/fable_distillation_granite41-3b_fable-glint_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_granite41_3b_b_train_output.ipynb"
