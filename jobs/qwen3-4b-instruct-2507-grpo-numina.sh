...
HUB_MODEL_ID="ermiaazarkhalili/Qwen3-4B-Instruct-2507-GRPO-NuminaMath"
GGUF_REPO_ID="ermiaazarkhalili/Qwen3-4B-Instruct-2507-GRPO-NuminaMath-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen3-4b-instruct-2507-grpo-numina-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --report_to trackio \
    --project "grpo-numina" \
    --run_name "qwen3-4b-instruct-2507-grpo-numina-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Qwen3-4B-Instruct-2507-GRPO-NuminaMath" \
