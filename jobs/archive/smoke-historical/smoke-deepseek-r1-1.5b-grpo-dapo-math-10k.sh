#!/bin/bash
# =============================================================================
# DeepSeek-R1-Distill-Qwen-1.5B GRPO Training on DAPO-Math-17k-Processed
...
HUB_MODEL_ID='ermiaazarkhalili/DeepSeek-R1-Distill-Qwen-1.5B-GRPO-DAPO-Math-17k-Processed-smoke-100'
GGUF_REPO_ID='ermiaazarkhalili/DeepSeek-R1-Distill-Qwen-1.5B-GRPO-DAPO-Math-17k-Processed-smoke-100-GGUF'
...
export OUTPUT_DIR="$SCRATCH/outputs/deepseek-r1-distill-qwen-1.5b-grpo-dapo-math-17k-processed-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "deepseek-r1-distill-qwen-1.5b-grpo-dapo-math-17k" \
    --run_name "deepseek-r1-distill-qwen-1.5b-grpo-dapo-math-17k-processed-$SLURM_JOB_ID" \
    --streaming \
    --max_samples 100 \
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "DeepSeek-R1-Distill-Qwen-1.5B-GRPO-DAPO-Math-17k-Processed-smoke-100" \
