#!/bin/bash
# =============================================================================
# SMOKE TEST: LFM2.5-1.2B GRPO on Claude Reasoning Distillation
# 100 samples, <1h, validates: GRPO training with claude-reasoning-distillation grpo config
# =============================================================================

#SBATCH --job-name=lfm2.5-1.2b-grpo-claude
...
HUB_MODEL_ID='ermiaazarkhalili/LFM2.5-1.2B-GRPO-Claude-Reasoning-smoke-100'
...
# =============================================================================
echo "=========================================="
echo "SMOKE: LFM2.5-1.2B GRPO Claude Reasoning"
...
export OUTPUT_DIR="$SCRATCH/outputs/lfm2.5-1.2b-grpo-claude-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "lfm2.5-1.2b-grpo-claude-reasoning" \
    --run_name "lfm2.5-1.2b-grpo-claude-smoke-$SLURM_JOB_ID" \
    --streaming \
