#!/bin/bash
# =============================================================================
# SMOKE TEST: Gemma4-E2B GRPO on Claude Reasoning Distillation
# 100 samples, <1h, validates: GRPO training with claude-reasoning-distillation grpo config
# =============================================================================

#SBATCH --job-name=gemma4-e2b-grpo-claude
...
HUB_MODEL_ID='ermiaazarkhalili/Gemma4-E2B-GRPO-Claude-Reasoning-smoke-100'
...
# =============================================================================
echo "=========================================="
echo "SMOKE: Gemma4-E2B GRPO Claude Reasoning"
...
export OUTPUT_DIR="$SCRATCH/outputs/gemma4-e2b-grpo-claude-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "gemma4-e2b-grpo-claude-reasoning" \
    --run_name "gemma4-e2b-grpo-claude-smoke-$SLURM_JOB_ID" \
    --streaming \
