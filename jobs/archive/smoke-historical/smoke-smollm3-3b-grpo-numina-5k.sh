#!/bin/bash
# =============================================================================
# SmolLM3-3B GRPO Training on NuminaMath-CoT
# Auto-generated by SLURM Job Generator
# =============================================================================

#SBATCH --job-name=smollm3-3b-grpo-numinamath-cot
...
HUB_MODEL_ID='ermiaazarkhalili/SmolLM3-3B-GRPO-NuminaMath-smoke-100'
GGUF_REPO_ID='ermiaazarkhalili/SmolLM3-3B-GRPO-NuminaMath-smoke-100-GGUF'
...
export OUTPUT_DIR="$SCRATCH/outputs/smollm3-3b-grpo-numinamath-cot-$SLURM_JOB_ID"
...
PYTHONUNBUFFERED=1 python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "smollm3-3b-grpo-numinamath" \
    --run_name "smollm3-3b-grpo-numinamath-cot-$SLURM_JOB_ID" \
    --streaming \
    --max_samples 100 \
...
PYTHONUNBUFFERED=1 python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "SmolLM3-3B-GRPO-NuminaMath-smoke-100" \
