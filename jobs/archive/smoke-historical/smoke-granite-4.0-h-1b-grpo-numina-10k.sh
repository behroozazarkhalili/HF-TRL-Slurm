#!/bin/bash
# =============================================================================
# granite-4.0-h-1b GRPO Training on NuminaMath-CoT
# Auto-generated by SLURM Job Generator
# =============================================================================

#SBATCH --job-name=granite-4.0-h-1b-grpo-numinamath-cot
...
HUB_MODEL_ID='ermiaazarkhalili/granite-4.0-h-1b-GRPO-NuminaMath-smoke-50'
GGUF_REPO_ID='ermiaazarkhalili/granite-4.0-h-1b-GRPO-NuminaMath-smoke-50-GGUF'
...
export OUTPUT_DIR="$SCRATCH/outputs/granite-4.0-h-1b-grpo-numinamath-cot-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "granite-4.0-h-1b-grpo-numinamath" \
    --run_name "granite-4.0-h-1b-grpo-numinamath-cot-$SLURM_JOB_ID" \
    --streaming \
    --max_samples 50 \
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "granite-4.0-h-1b-GRPO-NuminaMath-smoke-50" \
