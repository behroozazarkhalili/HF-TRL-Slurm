#!/bin/bash
# =============================================================================
# OpenReasoning-Nemotron-1.5B GRPO Training on NuminaMath-CoT
# Auto-generated by SLURM Job Generator
# =============================================================================

#SBATCH --job-name=openreasoning-nemotron-1.5b-grpo-numinamath-cot
...
HUB_MODEL_ID='ermiaazarkhalili/OpenReasoning-Nemotron-1.5B-GRPO-NuminaMath-smoke-50'
GGUF_REPO_ID='ermiaazarkhalili/OpenReasoning-Nemotron-1.5B-GRPO-NuminaMath-smoke-50-GGUF'
...
export OUTPUT_DIR="$SCRATCH/outputs/openreasoning-nemotron-1.5b-grpo-numinamath-cot-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --hub_strategy end \
    --report_to trackio \
    --project "openreasoning-nemotron-1.5b-grpo-numinamath" \
    --run_name "openreasoning-nemotron-1.5b-grpo-numinamath-cot-$SLURM_JOB_ID" \
    --streaming \
    --max_samples 50 \
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "OpenReasoning-Nemotron-1.5B-GRPO-NuminaMath-smoke-50" \
