...
HUB_MODEL_ID='ermiaazarkhalili/granite-4.0-micro-GRPO-NuminaMath-smoke-100'
GGUF_REPO_ID='ermiaazarkhalili/granite-4.0-micro-GRPO-NuminaMath-smoke-100-GGUF'
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "granite-4.0-micro-GRPO-NuminaMath-smoke-100" \
