#!/bin/bash
# =============================================================================
# Qwen3-0.6B SFT Training on OpenHermes-2.5
# Full Pipeline: Train -> Eval (MMLU, IFEval) -> GGUF Conversion -> HF Upload
# =============================================================================

#SBATCH --job-name=qwen3-0.6b-sft-openhermes
...
HUB_MODEL_ID="ermiaazarkhalili/Qwen3-0.6B-SFT-OpenHermes"
GGUF_REPO_ID="ermiaazarkhalili/Qwen3-0.6B-SFT-OpenHermes-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen3-0.6b-sft-openhermes-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_sft.py \
    ...
    --run_name "qwen3-0.6b-sft-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Qwen3-0.6B-SFT-OpenHermes" \
