#!/bin/bash
# =============================================================================
# granite-4.0-micro GRPO Training on NuminaMath-CoT
# Auto-generated by SLURM Job Generator
# =============================================================================

#SBATCH --job-name=granite-4.0-micro-grpo-numinamath-cot
...
MAX_SAMPLES=20000
SAMPLE_SIZE_LABEL="20K"

HUB_MODEL_ID='ermiaazarkhalili/granite-4.0-micro-GRPO-NuminaMath-20K'
GGUF_REPO_ID='ermiaazarkhalili/granite-4.0-micro-GRPO-NuminaMath-20K-GGUF'
...
export OUTPUT_DIR="$SCRATCH/outputs/granite-4.0-micro-grpo-numinamath-cot-$SLURM_JOB_ID"
...
PYTHONUNBUFFERED=1 python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --run_name "granite-4.0-micro-grpo-numinamath-cot-$SLURM_JOB_ID" \
    --streaming \
    --max_samples 20000 \
...
PYTHONUNBUFFERED=1 python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "granite-4.0-micro-GRPO-NuminaMath-20K" \
