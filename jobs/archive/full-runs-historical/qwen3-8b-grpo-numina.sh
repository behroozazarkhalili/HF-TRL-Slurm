#!/bin/bash
# =============================================================================
# Qwen3-8B GRPO Training on AI-MO/NuminaMath-CoT
...
# Note: Qwen3 models are instruction-tuned by default
# =============================================================================

#SBATCH --job-name=qwen3-8b-grpo-numina
...
HUB_MODEL_ID="ermiaazarkhalili/Qwen3-8B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}"
GGUF_REPO_ID="ermiaazarkhalili/Qwen3-8B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}-GGUF"

# GRPO Training parameters (optimized for 8B model on 80GB)
BATCH_SIZE=1
GRAD_ACCUM=4
LEARNING_RATE=5e-7
NUM_EPOCHS=1
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen3-8b-grpo-numina-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --report_to trackio \
    --project "grpo-numina" \
    --run_name "qwen3-8b-grpo-numina-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Qwen3-8B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}" \
