#!/bin/bash
# =============================================================================
# Qwen3-0.6B SFT Training on UltraChat-200k
# Full Pipeline: Train → Eval (MMLU, IFEval) → GGUF Conversion → HF Upload
# =============================================================================

#SBATCH --job-name=qwen3-0.6b-sft-ultrachat
...
GGUF_REPO_ID="ermiaazarkhalili/Qwen3-0.6B-SFT-UltraChat-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen3-0.6b-sft-$SLURM_JOB_ID
