#!/bin/bash
# =============================================================================
# Qwen3-14B SFT Training on UltraChat-200k
...
GGUF_REPO_ID="ermiaazarkhalili/Qwen3-14B-SFT-UltraChat-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen3-14b-sft-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_sft.py \
    ...
    --run_name "qwen3-14b-sft-$SLURM_JOB_ID"
