#!/bin/bash
# =============================================================================
# Qwen3-8B SFT Training on UltraChat-200k
# Full Pipeline: Train → Eval (MMLU, GSM8K) → GGUF Conversion → HF Upload
# =============================================================================

#SBATCH --job-name=qwen3-8b-sft-ultrachat
...
GGUF_REPO_ID="ermiaazarkhalili/Qwen3-8B-SFT-UltraChat-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen3-8b-sft-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_sft.py \
    ...
    --run_name "qwen3-8b-sft-$SLURM_JOB_ID"
