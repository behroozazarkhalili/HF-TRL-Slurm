#!/bin/bash
# =============================================================================
# Qwen2.5-3B SFT Training on UltraChat-200k
# Full Pipeline: Train → Eval (MMLU, GSM8K) → GGUF Conversion → HF Upload
# =============================================================================

#SBATCH --job-name=qwen2.5-3b-sft-ultrachat
...
GGUF_REPO_ID="ermiaazarkhalili/Qwen2.5-3B-SFT-UltraChat-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/qwen2.5-3b-sft-$SLURM_JOB_ID
