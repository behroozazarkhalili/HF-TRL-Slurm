#!/bin/bash
# =============================================================================
# LFM2-2.6B SFT Training on UltraChat-200k
# Full Pipeline: Train → Eval (MMLU, IFEval) → GGUF Conversion → HF Upload
# =============================================================================

#SBATCH --job-name=lfm2-2.6b-sft-ultrachat
...
HUB_MODEL_ID="ermiaazarkhalili/LFM2-2.6B-SFT-UltraChat"
GGUF_REPO_ID="ermiaazarkhalili/LFM2-2.6B-SFT-UltraChat-GGUF"
...
export OUTPUT_DIR=$SCRATCH/outputs/lfm2-2.6b-sft-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_sft.py \
    ...
    --run_name "lfm2-2.6b-sft-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "LFM2-2.6B-SFT-UltraChat" \
