...
HUB_MODEL_ID="ermiaazarkhalili/LFM2-2.6B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}"
GGUF_REPO_ID="ermiaazarkhalili/LFM2-2.6B-GRPO-NuminaMath-${SAMPLE_SIZE_LABEL}-GGUF"

# GRPO Training parameters - OPTIMIZED for speed (12,500 steps instead of 25,000)
BATCH_SIZE=1
GRAD_ACCUM=8              # Increased from 4 to 8 for faster training
LEARNING_RATE=5e-7
NUM_EPOCHS=1
...
export OUTPUT_DIR=$SCRATCH/outputs/lfm2-2.6b-grpo-numina-$SLURM_JOB_ID
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --report_to trackio \
    --project "grpo-numina" \
    --run_name "lfm2-2.6b-grpo-numina-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "LFM2-2.6B-GRPO-NuminaMath" \
