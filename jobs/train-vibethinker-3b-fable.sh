#!/bin/bash
#SBATCH --job-name=train-vibethinker-3b-fable
...
# Real training: VibeThinker-3B on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: VibeThinker-3B on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_vibethinker-3b_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_vibethinker_3b_d_train_output.ipynb"
