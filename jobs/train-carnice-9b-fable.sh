#!/bin/bash
#SBATCH --job-name=train-carnice-9b-fable
...
# Real training: Carnice-9B on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: Carnice-9B on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_carnice-9b_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_carnice_9b_d_train_output.ipynb"
