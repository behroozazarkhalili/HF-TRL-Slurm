#!/bin/bash
#SBATCH --job-name=smoke-qwen35-0.8b-fable-glint
...
OUTPUT_DIR="/scratch/$USER/outputs/fable-smoke-qwen35_08b-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "SMOKE: Qwen3.5-0.8B on FABLE-5 (Fable5-Glint)"
...
export NB_INPUT="$NB_DIR/fable_distillation_qwen35-0.8b_fable-glint_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_qwen35_08b_b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_qwen35_08b_b_smoke_output.ipynb"
