#!/bin/bash
#SBATCH --job-name=train-lfm2.5-350m-fable
...
# Real training: LFM2.5-350M on FABLE-5 (Fable5, 397,683 rows, 2 epochs).
...
echo "=========================================="
echo "TRAIN: LFM2.5-350M on FABLE-5 (Fable5)"
...
NB_INPUT="$NB_DIR/fable_distillation_lfm2.5-350m_fable_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/fable_lfm25_350m_d_train_output.ipynb"
