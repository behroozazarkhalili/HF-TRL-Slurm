...
HUB_MODEL_ID="ermiaazarkhalili/Qwen2.5-3B-Instruct-GRPO-OpenMath2"
GGUF_REPO_ID="ermiaazarkhalili/Qwen2.5-3B-Instruct-GRPO-OpenMath2-GGUF"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/train_grpo.py \
    ...
    --run_name "qwen2.5-3b-grpo-$SLURM_JOB_ID"
...
python /project/6014832/ermia/HF-TRL/.claude/skills/slurm-model-trainer/scripts/generate_model_card.py \
    --model_name "Qwen2.5-3B-Instruct-GRPO-OpenMath2" \
