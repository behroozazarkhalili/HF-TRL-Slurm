#!/bin/bash
#SBATCH --job-name=train-vibethinker-3b-xlam
...
# =============================================================================
# Real (non-smoke) training: VibeThinker-3B xLAM function calling
...
OUTPUT_DIR="/scratch/$USER/outputs/unsloth-train-vibethinker-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"

mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "TRAIN: VibeThinker-3B xLAM function calling (full epoch)"
echo "=========================================="
...
NB_INPUT="$NB_DIR/xlam_function_calling_vibethinker-3b_unsloth.ipynb"
NB_OUTPUT="$OUTPUT_DIR/xlam_vibethinker_3b_train_output.ipynb"
