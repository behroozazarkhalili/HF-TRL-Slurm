#!/bin/bash
#SBATCH --job-name=smoke-qwen35-2b-fable-glint
...
OUTPUT_DIR="/scratch/$USER/outputs/fable-smoke-qwen35_2b-$(date +%Y%m%d)"
VENV="/scratch/ermia/venvs/hf_unsloth"
mkdir -p "$OUTPUT_DIR"

echo "=========================================="
echo "SMOKE: Qwen3.5-2B on FABLE-5 (Fable5-Glint)"
...
export NB_INPUT="$NB_DIR/fable_distillation_qwen35-2b_fable-glint_unsloth.ipynb"
export NB_SMOKE="$OUTPUT_DIR/fable_qwen35_2b_b_smoke_input.ipynb"
export NB_OUTPUT="$OUTPUT_DIR/fable_qwen35_2b_b_smoke_output.ipynb"
